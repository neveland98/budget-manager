...
public class BudgetController {
    ...
    public Integer updateCategory(@RequestBody Category updated) throws BudgetDaoException, NullArgumentException, InvalidArgumentException {return service.updateCategory(updated);}
